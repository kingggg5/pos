...
namespace SmartPos.Api.Data.Migrations
{
    ...
    [Migration("20260726094506_FinalizeBusinessTimeEventsPartialRefund")]
    partial class FinalizeBusinessTimeEventsPartialRefund
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartPos.Api.Models.FinancialEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("OrderReversalId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SmartPos.Api.Models.OrderReversal", b =>
                {
                    ...
                    b.Property<bool>("CouponUsageReleased")
                    ...
                    b.Property<bool>("IsFullOrderReversal")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int>("LoyaltyPointsEarnedReversed")
                        .HasColumnType("integer");

                    b.Property<int>("LoyaltyPointsRedeemedRestored")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SmartPos.Api.Models.OrderReversalItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TenantId", "OrderReversalId", "OrderItemId");

                    b.ToTable("OrderReversalItems");
                });
            ...
            modelBuilder.Entity("SmartPos.Api.Models.FinancialEvent", b =>
                {
                    ...
                    b.HasOne("SmartPos.Api.Models.OrderReversal", "OrderReversal")
                        .WithMany()
                        .HasForeignKey("OrderReversalId");

                    b.Navigation("CashShift");

                    b.Navigation("Order");

                    b.Navigation("OrderReversal");
                });
            ...
            modelBuilder.Entity("SmartPos.Api.Models.OrderReversalItem", b =>
                {
                    b.HasOne("SmartPos.Api.Models.OrderItem", "OrderItem")
                        .WithMany()
